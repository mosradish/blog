<x-app-layout>
    <x-slot name="header">
        <h2 class="w-full place-content-center text-center font-semibold text-xl text-gray-800">投稿一覧</h2>
    </x-slot>
    <div class="w-full px-[10%] mx-auto py-4">
        @auth
        ...
        @foreach($posts as $post)
            <div class="mt-2 p-4 border-4 rounded">
                ...
                <div class="text-gray-600 text-sm mx-2px">
                ...
                @auth
                    ...
                    @endif
                @endauth
                <p class="text-sm text-gray-600 text-right">{{ $post->created_at->format('Y/m/d H:i') }}</p>
            </div>
        @endforeach
    </div>
</x-app-layout>
