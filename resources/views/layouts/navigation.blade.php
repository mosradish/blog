            ...
            <div class="nav_left">
                ...
                @auth
                    ...
                    <div class="nav_name_box">
                        <x-nav-link :href="route('posts.index')" :active="request()->routeIs('posts.index')" class="nav_name">
                            {{ __('Posts') }}
                        </x-nav-link>
                    </div>

                    <div class="nav_name_box">
                        <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')" class="nav_name">
                            {{ __('Dashboard') }}
                        </x-nav-link>
                    </div>
